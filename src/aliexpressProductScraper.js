...
async function AliexpressProductScraper(productId, feedbackLimit) {
  ...
  var category = {}
  try{
    const [el] = await page.$x('/html/body/div[6]/div/div[3]/div[3]/div[2]/div[3]/div[3]/div/div[3]/a[1]');
  ...
  try {
    const [el1] = await page.$x('/html/body/div[6]/div/div[3]/div[3]/div[2]/div[3]/div[3]/div/div[3]/a[2]');
    const txt1 = await el1.getProperty('textContent')
    var rawTxt1 = await txt1.jsonValue()
    category.two = rawTxt1
  } catch (err) {
    var rawTxt1 = '';
  }
  ...
  try {
    const [el2] = await page.$x('/html/body/div[6]/div/div[3]/div[3]/div[2]/div[3]/div[3]/div/div[3]/a[4]');
    const txt2 = await el2.getProperty('textContent')
    var rawTxt2 = await txt2.jsonValue()
    category.three = rawTxt2
  } catch (err) {
    var rawTxt2 = '';
  }
